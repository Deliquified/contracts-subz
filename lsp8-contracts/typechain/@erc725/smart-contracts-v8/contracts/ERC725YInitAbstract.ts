...
export interface ERC725YInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getData"
      | "getDataBatch"
...
export interface ERC725YInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): ERC725YInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: ERC725YInitAbstractInterface;
