...
export interface MyVotingNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface MyVotingNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MyVotingNFT;
  waitForDeployment(): Promise<this>;

  interface: MyVotingNFTInterface;
