...
export interface MyVotingTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface MyVotingToken extends BaseContract {
  connect(runner?: ContractRunner | null): MyVotingToken;
  waitForDeployment(): Promise<this>;

  interface: MyVotingTokenInterface;
  ...
  mint: TypedContractMethod<
    [rec: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
