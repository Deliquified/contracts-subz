...
export interface LSP7MintableInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface LSP7MintableInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7MintableInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP7MintableInitAbstractInterface;
