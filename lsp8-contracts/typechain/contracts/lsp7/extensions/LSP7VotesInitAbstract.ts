...
export declare namespace LSP7VotesInitAbstract {
...
export interface LSP7VotesInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface LSP7VotesInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7VotesInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP7VotesInitAbstractInterface;
  ...
  checkpoints: TypedContractMethod<
    ...
    [LSP7VotesInitAbstract.CheckpointStructOutput],
    "view"
  >;
