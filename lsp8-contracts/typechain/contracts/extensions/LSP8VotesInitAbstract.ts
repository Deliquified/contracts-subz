...
export interface LSP8VotesInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface LSP8VotesInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP8VotesInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP8VotesInitAbstractInterface;
