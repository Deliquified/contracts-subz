...
export interface LSP8SubscriptionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "mintSubscription",
...
export namespace SubscriptionCreatedEvent {
  export type InputTuple = [contractAddress: AddressLike, tokenId: BytesLike];
  export type OutputTuple = [contractAddress: string, tokenId: string];
  export interface OutputObject {
...
export interface LSP8Subscription extends BaseContract {
  connect(runner?: ContractRunner | null): LSP8Subscription;
  waitForDeployment(): Promise<this>;

  interface: LSP8SubscriptionInterface;
  ...
  mintSubscription: TypedContractMethod<
    [
      to: AddressLike,
      name: string,
  ...
  >;
  getFunction(
    nameOrSignature: "mintSubscription"
  ): TypedContractMethod<
    [
      to: AddressLike,
      name: string,
  ...
  filters: {
    ...
    "SubscriptionCreated(address,bytes32)": TypedContractEvent<
      SubscriptionCreatedEvent.InputTuple,
      SubscriptionCreatedEvent.OutputTuple,
      SubscriptionCreatedEvent.OutputObject
    >;
