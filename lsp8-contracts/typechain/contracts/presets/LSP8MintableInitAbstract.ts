...
export interface LSP8MintableInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface LSP8MintableInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP8MintableInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP8MintableInitAbstractInterface;
