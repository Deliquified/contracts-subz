...
import type {
  LSP8Base,
  LSP8BaseInterface,
} from "../../../contracts/presets/LSP8Base";
...
export class LSP8Base__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8BaseInterface {
    return new Interface(_abi) as LSP8BaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): LSP8Base {
    return new Contract(address, _abi, runner) as unknown as LSP8Base;
  }
}
