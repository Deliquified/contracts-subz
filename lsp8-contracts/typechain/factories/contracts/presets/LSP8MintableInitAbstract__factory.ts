...
import type {
  ...
  LSP8MintableInitAbstractInterface,
} from "../../../contracts/presets/LSP8MintableInitAbstract";
...
export class LSP8MintableInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8MintableInitAbstractInterface {
    return new Interface(_abi) as LSP8MintableInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8MintableInitAbstract;
  }
}
