...
import type {
  LSP7CappedSupply,
  LSP7CappedSupplyInterface,
} from "../../../../contracts/lsp7/extensions/LSP7CappedSupply";
...
export class LSP7CappedSupply__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7CappedSupplyInterface {
    return new Interface(_abi) as LSP7CappedSupplyInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP7CappedSupply {
    return new Contract(address, _abi, runner) as unknown as LSP7CappedSupply;
  }
}
