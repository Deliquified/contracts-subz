...
import type {
  ...
  LSP7VotesInitAbstractInterface,
} from "../../../../contracts/lsp7/extensions/LSP7VotesInitAbstract";
    ...
    outputs: [
      {
        ...
        internalType: "struct LSP7VotesInitAbstract.Checkpoint",
        name: "",
        type: "tuple",
      },
    ],
...
export class LSP7VotesInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7VotesInitAbstractInterface {
    return new Interface(_abi) as LSP7VotesInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP7VotesInitAbstract;
  }
}
