...
import type {
  ...
  LSP7BurnableInitAbstractInterface,
} from "../../../../contracts/lsp7/extensions/LSP7BurnableInitAbstract";
...
export class LSP7BurnableInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7BurnableInitAbstractInterface {
    return new Interface(_abi) as LSP7BurnableInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP7BurnableInitAbstract;
  }
}
