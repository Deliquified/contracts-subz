...
import type {
  ...
  LSP7MintableInitAbstractInterface,
} from "../../../../contracts/lsp7/presets/LSP7MintableInitAbstract";
...
export class LSP7MintableInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7MintableInitAbstractInterface {
    return new Interface(_abi) as LSP7MintableInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP7MintableInitAbstract;
  }
}
