...
import type {
  ...
  LSP7DigitalAssetInitAbstractInterface,
} from "../../../contracts/lsp7/LSP7DigitalAssetInitAbstract";
...
export class LSP7DigitalAssetInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7DigitalAssetInitAbstractInterface {
    return new Interface(_abi) as LSP7DigitalAssetInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP7DigitalAssetInitAbstract;
  }
}
