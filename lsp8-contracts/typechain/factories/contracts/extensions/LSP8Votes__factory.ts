...
import type {
  LSP8Votes,
  LSP8VotesInterface,
} from "../../../contracts/extensions/LSP8Votes";
...
export class LSP8Votes__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8VotesInterface {
    return new Interface(_abi) as LSP8VotesInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): LSP8Votes {
    return new Contract(address, _abi, runner) as unknown as LSP8Votes;
  }
}
