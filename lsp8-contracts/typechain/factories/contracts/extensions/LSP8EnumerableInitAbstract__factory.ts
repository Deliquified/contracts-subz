...
import type {
  ...
  LSP8EnumerableInitAbstractInterface,
} from "../../../contracts/extensions/LSP8EnumerableInitAbstract";
...
export class LSP8EnumerableInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8EnumerableInitAbstractInterface {
    return new Interface(_abi) as LSP8EnumerableInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8EnumerableInitAbstract;
  }
}
