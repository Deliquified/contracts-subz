...
import type {
  ...
  LSP8BurnableInitAbstractInterface,
} from "../../../contracts/extensions/LSP8BurnableInitAbstract";
...
export class LSP8BurnableInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8BurnableInitAbstractInterface {
    return new Interface(_abi) as LSP8BurnableInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8BurnableInitAbstract;
  }
}
