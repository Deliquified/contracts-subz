...
import type {
  ...
  LSP8CappedSupplyInitAbstractInterface,
} from "../../../contracts/extensions/LSP8CappedSupplyInitAbstract";
...
export class LSP8CappedSupplyInitAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8CappedSupplyInitAbstractInterface {
    return new Interface(_abi) as LSP8CappedSupplyInitAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8CappedSupplyInitAbstract;
  }
}
