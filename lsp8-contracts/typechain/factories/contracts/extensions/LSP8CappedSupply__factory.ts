...
import type {
  LSP8CappedSupply,
  LSP8CappedSupplyInterface,
} from "../../../contracts/extensions/LSP8CappedSupply";
...
export class LSP8CappedSupply__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8CappedSupplyInterface {
    return new Interface(_abi) as LSP8CappedSupplyInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP8CappedSupply {
    return new Contract(address, _abi, runner) as unknown as LSP8CappedSupply;
  }
}
