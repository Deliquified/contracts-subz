...
import type {
  LSP8Burnable,
  LSP8BurnableInterface,
} from "../../../contracts/extensions/LSP8Burnable";
...
export class LSP8Burnable__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8BurnableInterface {
    return new Interface(_abi) as LSP8BurnableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP8Burnable {
    return new Contract(address, _abi, runner) as unknown as LSP8Burnable;
  }
}
